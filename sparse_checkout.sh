...
git_folder_location='./run/'   #replace with the local root folder location where you want to create the project folder
...
project_template_github_url=https://github.com/Azure/mlops-project-template/tree/feature/feathr #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
